   ...
   <div id="carouselCabinet" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
         <div class="carousel-item active">
            <img src="<?= CHEMIN_IMAGES ?>exterieur.svg" class="d-block w-100" style="height=1080px;" alt="Extérieur du cabinet">
         </div>
         <div class="carousel-item">
            <img src="<?= CHEMIN_IMAGES ?>acces_cabinet.svg" class="d-block w-100" style="height=1080px;" alt="Accès du cabinet">
         </div>
         <div class="carousel-item">
      ...
      <button class="carousel-control-next" type="button" data-bs-target="#carouselCabinet" data-bs-slide="next">
